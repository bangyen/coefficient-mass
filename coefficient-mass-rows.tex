...
below the second on this diagonal.  The pair $S=\{2,3\}$ is the only
...
\end{align*}
Then $V_r(15,2)=\beta_r(14)=1/\Phi_r(Y_{14})=15.0390\ldots=\min_{i\le3}1/\nu_i(14)$
...
fails at $(\frac43,16,3)$.  The pair $S=\{2,3\}$ is the only exempted set
...
$\{1,2,5,7,11,15,20,25,32,40,50,61,77\}\supseteq[1,2]$ give
$\nu_2(12),\nu_3(12)<\nu_1(12)$, so
$\min_{i\le3}1/\nu_i(12)=1/\nu_1(12)$.
...
and $\{1,2,4,7,10,13,17,22,28,34,42,50,61,73,90\}\supseteq[1,2]$ give
$\nu_2(14),\nu_3(14)<\nu_1(14)$.
...
computations behind Proposition~\ref{prop:secondrowexact} are in
