...
REFERENCES = {
    ...
    ("coefficient-mass-rows", "3.4"): ("Lemma", "lem:nbmass"),
    ("coefficient-mass-rows", "3.5"): ("Corollary", "cor:belowtwo"),
    ...
    ("coefficient-mass-rows", "6.21"): ("Lemma", "lem:block"),
}
...
HEADLINES = {
    ...
    "nbMass": ("NbMass", "coefficient-mass-rows", "lem:nbmass"),
    "belowTwo": ("BelowTwo", "coefficient-mass-rows", "cor:belowtwo"),
