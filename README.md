...
| `tests/test_complex.py` | multisection transfer, imaginary pairs, first row at Gaussian roots, Gaussian blocks and heavy coefficients, several annuli, both signs, and wide sectors, on seeded integer multiples and exact optima |
