...
multiple attains the infimum; an exact rational linear-programming
computation over every degree at most $10$ and every exempt position gives
$b_2\ge41.2$ for those multiples.
...
exactly when $T=\tau^*$ and gives the infimum for $r\ge\tfrac{29}{20}$
