...
root set: at $(\tfrac32,3,5,7)$ with $u=1$ every placement up to distance
$12$ stays strictly below $\tau^*$.
...
placement stays extremal (at $(\tfrac32,3,5,7)$ with $u=1$, every placement up to distance $12$ stays numerically below $\tau^*$) are
left open.
