...
mechanism is sharp in every sector of half-width $\delta<\pi/2$.  In a sector of fixed half-width the
least mass guaranteed for every set of $K$ roots is therefore linear in $K$, and $\Lambda\ge cK^2\log R$ fails already
...
Nor, numerically, does a single heavy coefficient suffice.  If $F=H(x)-v$ with
