...
(Proposition~\ref{prop:gaussheavy}).
...
$E(2\delta)>1.596>\pi/2$, and $E$ is increasing): the theorem is meant for
...
above the axis can share such a level set: $(y^3-y)^2$ takes the value
$-100$ at $\pm2+i$ and $2i$, since $y^3-y$ is $\pm10i$ there, and $y^8+3y^4$
the value $4$ at $\pm1+i$ and $i$, since $y^4$ is $-4$ and $1$ there.  Whether the number of Gaussian points above the axis in one level set
