...
attained, constant included, as $\min_sT_s\to\infty$
(Corollary~\ref{cor:annuli}, Proposition~\ref{prop:annulisharp}).
...
$\rho_j/3$ and an extra factor $\frac12$ in each row.  Item~1 is sharp,
constant included, as $\min_sT_s\to\infty$ (Proposition~\ref{prop:annulisharp}
