...
at most $s\in\{8,10,11\}$ whose coefficients, the leading one included, are all small
finds no level set with more than three Gaussian points above the axis
...
value taken at more than three such $y$.  A real $F$ of degree below $8$ has at
most three roots above the axis, so only these ranges, with $s\ge8$, are
informative.  Three such $y$ occur, in these ranges and in
