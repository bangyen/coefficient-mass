...
$K,R\to\infty$ with $\delta K\to0$) and $\pi$ of $(K/\delta)\log R$ (at fixed
$\delta$, as $K,R\to\infty$) attained
in the limit; at
...
$\frac12K^2\log R$ as $R\to\infty$ and $K\to\infty$ with $\delta K\to0$, from
