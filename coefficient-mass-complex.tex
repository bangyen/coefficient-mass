...
$K\to\infty$ with $\delta K\to0$) and $\pi$ of $(K/\delta)\log R$ (at fixed
$\delta$, $K\to\infty$) attained
in the limit; at
...
$\frac12K^2\log R$ for fixed $T$ and $K\to\infty$ with $\delta K\to0$, from
Theorem~\ref{thm:widesector} with $m=K-1-\lceil\omega+\delta K^2/(2\pi)\rceil$
...
and $K\to\infty$, against Proposition~\ref{prop:widesharp}.  In a wide
sector, with $\delta$ fixed, it is linear in $K$, and
