...
coefficient of modulus at least $1$ have mass
$(\frac12-o(1))K^2\log R$ if $\delta K\to0$ and $(\frac\pi\delta-o(1))K\log R$
...
\eqref{eq:order} applies.  In a sector of half-width $\delta\le\pi/4$ this
gives mass at least $\frac{K(K-2)}8\log(\frac R2-1)$ for multiples with
$|b_d|\ge1$ of degree at most
...
large zeros; as $K,R\to\infty$, multiples of degree $O(K)$ with $|b_d|\ge1$ pay
...
mechanism is sharp in every sector.  In a sector of fixed half-width the
