...
bound $H(P)\ge|P(1)|$ of~\cite{dj}, proved there for real roots greater
than one, where the two agree.  At complex roots $|P(1)|$ is not a lower
bound: for $x^2+\rho^2$ it is $\rho^2+1$, while monic multiples have $b_1$
arbitrarily close to $\rho^2-1$ (Corollary~\ref{cor:imag}).
...
Theorem~\ref{thm:thinsector}).  At distinct Gaussian-integer roots in the
