...
least $T_s$ in the $s$-th of $S$ annuli, consecutive annuli separated by
...
half-width $\delta<\pi/2$, multiples of degree $O(K)$ have mass
...
gives mass at least $\frac{K(K-2)}8\log(\frac R2-1)$ for multiples of degree at most
...
large zeros; as $K,R\to\infty$, multiples of degree $O(K)$ pay
