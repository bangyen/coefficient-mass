...
$\sum_ssK_s\log T_s$ in all when the separation grows with the number of
roots, attained for suitable roots as $\min_sT_s\to\infty$; the cross terms $K_uK_s\log T_s$ of \eqref{eq:order} fail
...
$\sum_ssK_s\log T_s$ up to lower order terms, and for suitable roots this is
