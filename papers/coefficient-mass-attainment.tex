...
\item The infimum along $(r,3,5,7)$ for $1<r<\tfrac{13}{10}$, where
Theorem~\ref{thm:family} gives only the upper bound $\tfrac{209}4$; at
$r=\tfrac54$ its proof breaks twice, as the multiplier $x+\kappa$ of the
lower bound gives $\max_{j\ne4}|S_j|>\beta(r)$ and the half-mass point is
$7$.
\end{itemize}
