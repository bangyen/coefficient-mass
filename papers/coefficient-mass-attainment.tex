...
$T\ge\tau^*$, and the questions are about $T$.
\begin{itemize}
\item An a priori bound on the zero set minimising a single $\tau(\{x\})$,
which would make the case $u=1$ a finite computation outright.
...
\item Whether the infimum along $(r,3,5,7)$ equals $\beta(r)$ on
$[\tfrac{13}{10},\tfrac{29}{20})$, where Theorem~\ref{thm:family} gives
