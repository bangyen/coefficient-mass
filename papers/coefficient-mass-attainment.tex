...
$4\times4$ systems, with the sign patterns given by the zero bound
(Appendix~\ref{sec:familydata} lists the solutions), the full
...
Theorem~\ref{thm:family} as rational functions of $r$, so that the tails
there can be checked by hand or by any computer algebra system.  Let
$1<r<3$, so that $\tfrac1r$ is the largest of the nodes
$\tfrac1r,\tfrac13,\tfrac15,\tfrac17$, and put
\[
  p(r)=(3-r)(5-r)(7-r),\qquad q(r)=3466r^2+7455r+11025 ,
\]
both positive on $(1,3)$.  Each sum below has the form
