...
For $F>0$ put $p(a)=(1-a)(\sum_{d\ge1}\sigma_da^d-t)$, the polynomial
\[
...
\]
where $\sum_{d>x}|U_d|\le t$, $\sum_{d>x}|V_d|\le s_1$ by
Theorem~\ref{thm:familyzero}(a), and
$0<\sum_{d>x}V'_d=(\tfrac32A-\tfrac52B+\tfrac76C)/D<1$.  As
...
$\beta=(\tfrac35)^x$, and let $\varepsilon\le(\delta/10)^4\le20^{-4}$.  As
...
$c\le60$ or $x\le60$; the limits, and the estimates with logarithms and
powers $\alpha$, are by hand.  The file also holds tests used in no
