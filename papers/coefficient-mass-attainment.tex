...
paragraph on computer assistance before the appendix.  Along $(r,5,7)$ the
...
positive integer $x\ne4$.  On $[\tfrac{13}{10},\tfrac{29}{20})$ only the
upper bound $\beta(r)$ is proved (Section~\ref{sec:scope}).
\end{theorem}
...
Three computations are computer-assisted: steps of the proofs of
Theorems~\ref{thm:elevenvalue} and~\ref{thm:family}, and the failure of
...
Theorem~\ref{thm:family} as rational functions of $r$, written with
\[
  p(r)=(3-r)(5-r)(7-r),\qquad q(r)=3466r^2+7455r+11025 ,
\]
so that the tails $1/\beta(r)$ and
$t_2(r)=(4267r^2+5070r-5871)/\bigl(48(r-1)q(r)\bigr)$ there can be checked
