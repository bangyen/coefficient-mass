...
Eliminating the coefficient charged below with a zero of the next annulus
down gives $n_a+1$ once $n_a\ge30$, and for large $n_a$ the additive
constant is exactly $\frac12$: $n_a+c$ suffices for every $c>\frac12$ and
fails for every $c<\frac12$ (Theorem~\ref{thm:rowspair},
...
(Proposition~\ref{prop:rowstwolarge}).
The mass bound fails with $T_2=(2+\frac1{18915})U_1$
(Proposition~\ref{prop:gaptwo}), with two roots above the gap, where the
separation $9$ suffices (Corollary~\ref{cor:rowstwo}).
...
$2+\frac1{18915}$ and $81$ (and at most $9$ for two annuli with at most
eight roots in the upper one), and whether the separation $9$ of Corollary~\ref{cor:annuli},
...
$T_2>(n_2+1)U_1$ (Corollary~\ref{cor:rowstwo}), and for every $S$ at
...
(Proposition~\ref{prop:gaptwo}), and for two annuli $9$ suffices with at
most eight roots above the gap (Corollary~\ref{cor:rowstwo});
...
constant $c>0$ suffices once $n_2$ is large.  With $S=2$ and $n_2\le8$ this also gives the mass bound of
Theorem~\ref{thm:fixedgap} at the separation $9$.
...
(the remark after Corollary~\ref{cor:rowstwo}) and $c=0$ does not.  The
threshold $30$ is not optimized.  Whether $T_a>(n_a+1)U_{a-1}$ for every $a$
gives all the rows also when $n_a<30$ is open; there
Corollary~\ref{cor:rowsall} gives $n_a+9$, and $6$ at $n_a=1$.
...
$2+\frac1{18915}$ and $12$, and by Corollary~\ref{cor:rowstwo} even $9$; with one root in the upper annulus it is at
...
and $81$, in particular whether $9$ suffices.
