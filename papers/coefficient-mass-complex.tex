...
conjugate pairs), so the theorem is for $\delta\to0$.  At distinct Gaussian-integer roots in the
...
$\delta<0.0134$.  In a sector of
half-width $\delta<\pi/2$ the crossings
are counted against the equidistributed share $\delta/\pi$ of the
large zeros, in the spirit of the Erd\H{o}s--Tur\'an theorem~\cite{erdos-turan}; as $K,R\to\infty$, multiples of degree $O(K)$ with leading coefficient of modulus at least $1$ pay
