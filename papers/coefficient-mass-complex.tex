...
(Proposition~\ref{prop:rowsneedn}).  The mass bound fails with
$T_2=(2+\frac1{18915})U_1$ (Proposition~\ref{prop:gaptwo}), with two
roots above the gap, where the separation $9$ suffices
...
large, and at $\lambda=0$ this is Proposition~\ref{prop:rowsneedn}.  Whether
$\lambda^2$ can be replaced by $\lambda$ we do not know.
