...
lower zero $\alpha$ with $|\alpha|\ge2$, $b_2(F)$ is at least
$\lambda(1-1/|\alpha|)^2|f_D|\prod_\beta|\beta|$ over the $n$ zeros $\beta$
of modulus at least $T$, $\lambda=1-n|\alpha|/T$, with
...
\begin{proof}
Here $n_3=K$ and $n_2=K+1$, $T_3=U_3=t=(K+h)q_2>9U_2$ as $K\ge9$, and
