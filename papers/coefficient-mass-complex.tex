...
(Corollary~\ref{cor:fewabove}), and at the separation $n_a$,
...
roots above the gap, where the separation $12$ suffices
(Corollary~\ref{cor:fewabove}).
...
$2+\frac1{18915}$ and $81$ (and at most $12$ with two roots above the
gap), and whether the separation $9$ of Corollary~\ref{cor:annuli},
...
(Proposition~\ref{prop:rowsneedn}).  Item~2 needs only the factor $9$, but past the first
...
(Proposition~\ref{prop:gaptwo}), and $12$ suffices with two roots above the
gap (Corollary~\ref{cor:fewabove});
...
and the factor $n_a$ cannot be dropped.
...
(Corollary~\ref{cor:fewabove}), and not at most $n_a$.  For the mass the same cancellation with $K=2$ breaks
...
$2+\frac1{18915}$ and $12$; with one root in the upper annulus it is at
