...
Mathlib.  Not formalized are the equality case of Theorem~\ref{thm:tail},
the relaxation of $r_1\ge2$ to $r_1>1$ in the first row of
Lemma~\ref{lem:slack} and Theorem~\ref{thm:order}, and the worked examples.
Of Section~\ref{sec:sharp}, Proposition~\ref{prop:sharp23} and
Lemma~\ref{lem:rowcert} are formalized, together with the reduction of
Theorem~\ref{thm:everyrow} to \eqref{eq:starn}; the proof of
\eqref{eq:starn}, from Lemma~\ref{lem:confdel} on, and the rest of the
section are not.  The formal proofs, in the
