...
there is one for every $1<r<\frac{21}{20}$, remain open.  There a failure
at $(r,n+1,2)$ needs $\beta_r(n)>1$ (Theorem~\ref{thm:onepolyrows}), so by
Lemma~\ref{lem:topnearone} its diagonal $n$ tends to infinity as
$r\to1^+$.
