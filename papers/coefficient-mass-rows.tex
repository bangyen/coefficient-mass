...
numbers there.  Table~\ref{tab:notation} lists the notation used in more
than one place, with the section or result where it is defined; symbols
used only inside one proof are defined there.
...
Propositions~\ref{prop:secondrowexact} and~\ref{prop:thirdrowexact} are the
only computer-assisted results; every other result is proved by hand.  Their
...
\texttt{test\_second\_row\_*} and \texttt{test\_third\_row\_*} in
