...
finitely many exempted-position terms (Theorem~\ref{thm:secondrow}).  Every
...
third row of a diagonal while holding in the second.  The proofs of these two
...
$\nu_2(n)\ge\nu_1(n)$, and we do not know whether a worst exempted
position, when one exists, is always small, or whether the identity fails
for every $1<r<2$ or only near $1$.
