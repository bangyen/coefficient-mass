...
$\mu_r(S,L)$ decrease with $r$, a lower bound on $\eta_\sigma(n)$ certified
at one root and upper bounds on $\nu_1(n)$ and $\nu_2(n)$ at a smaller root
give a failure at every root between them, and finitely many certificates show that the identity fails
