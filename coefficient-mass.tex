...
positive nodes, making their reduced-height bound $H(P)\ge|P(1)|$ unconditional for
...
all distinct positive real nodes, so their bound $H(P)\ge|P(1)|$ on the reduced height $H(P)$, the infimum of the heights of the multiples $PQ$ with $Q$ monic, the row
