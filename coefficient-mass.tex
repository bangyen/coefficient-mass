...
\[
  ...
  =\frac{\ell+1}{s-\ell-1}\binom mj\Big/\binom{s-m-1+\ell}\ell .
\]
Apply $1/\binom\nu \ell=(\nu+1)\int_0^1t^\ell(1-t)^{\nu-\ell}\,dt$ with $\nu=s-m-1+\ell$, and
note that $\nu+1=s-m+\ell\le s-\ell-1$ because $m\ge2\ell+1$:
\[
  \prod_{c\in C}\frac c{s-c}\le(\ell+1)\binom mj\int_0^1t^\ell(1-t)^{s-m-1}\,dt .
\]
...
\[
  T(C,q)\le(\ell+1)\binom mj\int_0^1t^\ell
...
\[
  (q+1)\,T(C,q)\le\frac{\ell+1}e\binom mj\int_0^\infty t^{\ell-1}(1+t)^{-m-1}\,dt
  =\frac{\ell+1}e\binom mj\,\mathrm B(\ell,m-\ell+1)=\frac{\ell+1}{e\,\ell}.
\]
\end{proof}
